...
public static class NotificationEndpoints
{
    public static void MapNotificationEndpoints(this WebApplication app)
    {
        ...
        n.MapPost("/{id:long}/read", async (long id, NotificationService svc) => { await svc.MarkRead(id); return Results.Ok(); });
        n.MapPost("/read-all", async (NotificationService svc) => { await svc.MarkAllRead(); return Results.Ok(); });
    }
}
