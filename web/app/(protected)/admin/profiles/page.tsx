  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-zinc-500">按部门查看队员技能与认证 · 点击卡片进入详情</p>
      </div>
                ...
                <Link key={u.id} href={`/admin/profiles/${u.id}`}
                  ...
                  {skills.length > 0 && (
                    <div className="flex flex-wrap gap-1 mt-3">
                      ...
                      {skills.length > 4 && <span className="text-[11px] text-zinc-400 self-center">+{skills.length - 4}</span>}
                    </div>
                  )}
                  {certs.length > 0 && (
                    <div className="flex flex-wrap gap-1 mt-2">
                      ...
                      {certs.length > 2 && <span className="text-[11px] text-zinc-400 self-center">+{certs.length - 2}</span>}
                    </div>
                  )}
                </Link>
              );
